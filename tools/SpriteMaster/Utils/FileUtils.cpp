...
namespace SpriteMaster
{
    ...
    {
        return CreateDirectoryRecursive(folderPath);
    }
    ...
    void FileUtils::getFilenames(const std::string& fileOrPath, std::vector<std::string>& outFilenames)
    {
        ...
        {
            std::string folderPath = fileOrPath + "\\";
            ...
            std::string searchPattern = folderPath + "*.gal";
            ...
            if (hFind != INVALID_HANDLE_VALUE)
            {
                do
                {
                    ...
                    outFilenames.push_back(folderPath + fileName);
