	...
	for (size_t frameLoop = 0; frameLoop < m_frames.size(); frameLoop++)
	{
        ...
        else
        {
            ...
            for (const auto& sprite : frame.getSprites())
            {
                ...
                sourceFile << sprite.m_spriteStrip.frameStartIndex;
                sourceFile << " },\n";
            }
            sourceFile << "    {0},\n";
            sourceFile << "};\n\n";
                                             ...
                                             const std::string& bank)
{
    ...
    sourceFile << "#include \"draw_utils.h\"\n";
    sourceFile << "#include \"animation_types.h\"\n";
    sourceFile << "#include \"animation_utils.h\"\n";
